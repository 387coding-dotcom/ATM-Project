...
- Displays transaction-related messages to the user
...
The program starts by asking the user for their PIN.

After successful authentication, an ATM menu is displayed with different options such as:
...
The user selects an option and provides the required input.  
The program then performs the selected operation and displays the result in the terminal.
...
```bash
git clone https://github.com/387coding-dotcom/ATM-Project.git